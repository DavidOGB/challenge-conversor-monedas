                ...
                try {
                    switch (opcion) {
                        ...
                        case 1:
                            ...
                            System.out.printf("El valor de %.2f USD es %.2f ARS", valor, resultado);
                            break;
                        case 2:
                            Moneda moneda2 = conversor.convertirMoneda("ARS");
                            resultado = valor * moneda2.conversion_rates().get("USD");
                            System.out.printf("El valor de %.2f ARS es %.2f USD", valor, resultado);
                            break;

                        case 3:
                            Moneda moneda3 = conversor.convertirMoneda("USD");
                            resultado = valor * moneda3.conversion_rates().get("BRL");
                            System.out.printf("El valor de %.2f USD es %.2f BRL", valor, resultado);
                            break;
